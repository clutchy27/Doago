        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-8 shadow-2xl shadow-black/40">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-[#F97316]/8 border border-[#F97316]/15 rounded-xl px-4 py-3 text-center">
                <p className="text-orange-400 text-xs font-bold tracking-wide">Naročnik & Izvajalec</p>
                <p className="text-[#525252] text-xs mt-1">Objavljaš in sprejemaš naloge</p>
              </div>

              <button
                onClick={handleSubmit}
                disabled={loading}
                className="bg-[#F97316] text-white py-3.5 rounded-xl font-bold hover:bg-orange-600 transition-all duration-150 disabled:opacity-50 mt-1 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 hover:-translate-y-0.5"
              >
